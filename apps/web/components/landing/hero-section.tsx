...
const events = [
  ...
  {
    label: "vault-owner",
    detail: "Raised seat limit. On-chain transaction confirmed.",
  },
];
        ...
        <CardContent className="space-y-6 pt-6">
          <div className="grid gap-3 sm:grid-cols-3">
            {stats.map((stat) => (
              ...
              >
                <div
                  className={`h-1 w-12 rounded-full bg-linear-to-r ${stat.accent}`}
                />
...
export function HeroSection() {
  return (
    <section
      id="product"
      className="relative overflow-hidden px-6 pt-16 pb-20 lg:px-8 lg:pt-20 lg:pb-28"
    >
      <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <div className="max-w-2xl">
          <Badge
            variant="outline"
            className="border-cyan-400/20 bg-cyan-400/10 px-4 py-1.5 text-cyan-100"
          >
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300 sm:text-xl">
            Quota gives enterprises programmable spending limits for every AI
            agent and team member. Enforced by a Solana program. Not a database.
          </p>
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center">
            <Button
              asChild
              size="lg"
              className="rounded-full bg-cyan-400 px-6 text-slate-950 shadow-[0_18px_40px_rgba(34,211,238,0.24)] hover:bg-cyan-300"
            >
              <Link href="/signup">
                Start for free
