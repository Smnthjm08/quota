...
export function AuthSessionProvider({
  ...
  const [manualSession, setManualSession] = useState<AppSession>(initialSession);
  ...
  const refreshSession = useCallback(async () => {
    ...
    const refreshedSession = (
      (refreshedSessionResponse as { data?: AppSession })?.data ??
      (refreshedSessionResponse as AppSession)
    ) as AppSession;
